...
contract SolmateToken is ERC721, Ownable{
    /* ///////////////////////////////////////////////////////////////
    VARIABLES
    ////////////////////////////////////////////////////////////// */
    ...
    function redeem(uint256 tokenId, string calldata redemptionId) external {
        ...
        require(ownerOf(tokenId) == msg.sender, "Token not owned by the redeemer");
    ...
    // DISCLAIMER: function not supported by ERC721 standard (ERC721A required)
